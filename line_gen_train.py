#markov functions (by Allison Parrish)
import sys
import random
...
def word_level_generate(lines, n, count, max_iterations):
...
#parameters
text = raw_input("file: ")
fidelity = raw_input("fidelity, recommended 1-3: ")
max_iterations = raw_input("length, recommended 50: ")
...
while loop == 1:
    ...
    for line in fo:
    	line = line.strip()
    	lines.append(line)
    for generated in word_level_generate(lines, n, 1, int(max_iterations)):
    	print generated
        print " "
    #adder
